# GRPO: per-rollout reward
# - we scale the loss for selected rollout for each document
# - (1). advantage of 'per-doc-traj-perplexity'   --> encourage high advantage abstraction rollout
# - (2). perplexity of 'per-doc/token-abs-perplexity' --> encourage abstraction exploration
