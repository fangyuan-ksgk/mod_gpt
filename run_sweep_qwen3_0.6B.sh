#!/bin/bash
# Sweep: SFT baseline + SoRL configs on Qwen3-0.6B
#
# Layout:
#   1. SFT baseline (no abstract tokens)
#   2. SoRL sweep: alpha_info_gain × alpha_abs × alpha_soft_zipf × ortho_reg
#      with emb_lr_mult=10.0 (embedding LR = 1e-4) and lr=1e-5
#
# Usage:
#   bash run_sweep_qwen3_0.6B.sh
...
BASE_OUTPUT_DIR="./ckpt/sweep_qwen3_0.6B_${TIMESTAMP}"
mkdir -p "${BASE_OUTPUT_DIR}"

echo "============================================================"
echo "Sweep: Qwen3-0.6B  |  ${TIMESTAMP}"
