#!/bin/bash
# SoRL Ablation — Qwen3-1.7B — response_only_abs probe
#
...
run_bg "v3_r1.0_ro"            --num_epochs 3 $V3 --corrupt_ratio 1.0 --response_only_abs
...
run_bg "v4_i2_r1.0_ro"         --num_epochs 2 --n_inner 2 $V4 --corrupt_ratio 1.0 --response_only_abs
