#!/bin/bash
# ============================================================================
# SoRL Sweep — Qwen3-0.6B / GSM8K
#
# Baseline: v3 shuffle r=1.0 γ=0.5
#
# Questions:
...
#
# Step matching:
#   - Pure SoRL runs: 3 epochs
#   - Warmup runs: 500 warmup + 2 ep SoRL
...
# Baseline v3 config (best 0.6B: shuffle r=1.0 γ=0.5)
...
run_bg() {
  ...
  local tag=$1; shift
  local output_dir="./ckpt/sweep_0.6b_${TIMESTAMP}/exp${idx}_${tag}"
...
# 1. Baseline: v3 shuffle r=1.0 γ=0.5 (no jacobi, no mtraj)
run_bg "v3_baseline" \
...
echo ""
echo "============================================================"
echo "All 16 experiments complete. Results in ./ckpt/sweep_0.6b_${TIMESTAMP}/"
echo "============================================================"
echo ""
echo "Experiment matrix:"
echo "  Batch 1 (pure SoRL jacobi sweep):"
echo "    1  v3_baseline          — shuffle r=1.0 γ=0.5 (no jacobi, no mtraj)"
